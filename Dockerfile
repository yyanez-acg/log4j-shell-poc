...
COPY vulnerable-application/src/main/webapp/index.jsp /usr/local/tomcat/webapps/ROOT/
COPY vulnerable-application/src/main/webapp/logo_SG.png /usr/local/tomcat/webapps/ROOT/
